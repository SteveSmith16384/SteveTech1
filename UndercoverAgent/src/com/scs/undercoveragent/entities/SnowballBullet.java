...
public class SnowballBullet extends AbstractBullet implements INotifiedOfCollision {//IProcessByClient, ILaunchable, IRemoveOnContact, ICausesHarmOnContact, IClientControlled, INotifiedOfCollision {
