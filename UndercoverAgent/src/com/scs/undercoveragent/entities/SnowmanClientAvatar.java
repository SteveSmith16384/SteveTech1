...
public class SnowmanClientAvatar extends AbstractClientAvatar {
	...
	public SnowmanClientAvatar(AbstractGameClient _module, int _playerID, IInputDevice _input, Camera _cam, IHUD _hud, int eid, float x, float y, float z, int side) {
