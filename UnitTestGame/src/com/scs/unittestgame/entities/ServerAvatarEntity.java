...
public class ServerAvatarEntity extends AbstractServerAvatar {
	...
	public ServerAvatarEntity(IEntityController _module, ClientData _client, int eid) {
		super(_module, UnitTestGameServer.AVATAR_ID, _client, new UnitTestInputDevice(), eid, new AvatarModel(), 1f, 0, new PersonAvatarControl(_module, new UnitTestInputDevice(), 1f, 1f));
