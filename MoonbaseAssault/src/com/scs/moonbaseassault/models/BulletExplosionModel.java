...
public class BulletExplosionModel extends Node {
	...
	public BulletExplosionModel(AssetManager _assetManager, RenderManager renderManager) {
		super("BulletExplosionModel");
		...
		explosionEffect.scale(0.000001f);
