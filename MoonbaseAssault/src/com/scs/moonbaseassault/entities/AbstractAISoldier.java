...
IRewindable, IAnimatedClientSide, IAnimatedServerSide, IDrawOnHUD, IProcessByClient, IGetRotation, ISetRotation, IKillable, ITargetable, IHasSide {
	...
	public static final float RUNNING_SPEED = 1.21f;//1.19f; //1.13f; //0.93
